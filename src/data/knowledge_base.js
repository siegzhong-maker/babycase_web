export const KNOWLEDGE_BASE = [
  // --- 孕期 (Pregnancy) ---
  {
    ...
    tags: ["胎动", "数胎动", "不动了", "踢我"],
    display_tag: "👣 怎么数胎动",
    core_question: "怎么正确数胎动？",
    related_scenarios: ["胎动减少", "胎动频繁", "打嗝", "孕晚期监测"],
    decision_criteria: "对象=孕妈 且 孕周≥28周 → 需要数胎动",
  ...
  },
  {
    ...
    tags: ["孕吐", "恶心", "吐得厉害", "吃不下"],
    display_tag: "🤢 孕吐太难受",
    core_question: "孕妈孕吐怎么缓解？",
    related_scenarios: ["早孕反应", "恶心", "脱水", "妊娠剧吐"],
    decision_criteria: "对象=孕妈 且 症状=恶心/呕吐 → 孕吐护理",
  ...
  },
  {
    ...
    display_tag: "",
    core_question: "宝宝吐奶怎么护理？",
    related_scenarios: ["溢奶", "拍嗝", "幽门狭窄", "防窒息"],
    decision_criteria: "对象=宝宝 且 症状=喂奶后吐出 → 吐奶护理",
  ...
  // --- 疫苗/接种相关 ---
  {
    ...
    tags: ["水痘", "水痘疫苗", "水痘接种"],
    display_tag: "💉 水痘疫苗/护理",
    core_question: "水痘疫苗怎么打？得了水痘怎么护理？",
    related_scenarios: ["疫苗接种", "皮疹", "发热", "隔离"],
    decision_criteria: "涉及水痘疫苗或水痘症状 → 水痘相关护理",
  ...
  // --- 具体感冒分支 ---
  {
    ...
    decision_criteria: "对象=孕妈 且 症状=感冒/发烧 → 孕期感冒护理",
  ...
  },
  {
    ...
    tags: [], // 仅通过追问触发
    display_tag: "",
    core_question: "宝宝感冒怎么护理？",
    related_scenarios: ["流鼻涕", "咳嗽", "发烧", "就医指征"],
    decision_criteria: "对象=宝宝 且 症状=感冒相关 → 宝宝感冒护理",
  ...
  },
  {
    ...
    decision_criteria: "对象=宝妈 且 症状=感冒/发烧 → 哺乳期感冒护理",
  ...
  // --- 睡眠相关 (Sleep) ---
  {
    ...
    decision_criteria: "对象=宝宝/孕妈/宝妈 分别对应不同睡眠问题与解决方案",
    clarify_options: [
  ...
  },
  {
    ...
    display_tag: "",
    core_question: "宝宝频繁夜醒怎么处理？",
    related_scenarios: ["睡眠训练", "睡前仪式", "接觉", "白天小睡"],
    decision_criteria: "对象=宝宝 且 症状=频繁夜醒（排除饿和尿） → 睡眠训练",
  ...
  },
  {
    ...
    decision_criteria: "对象=孕妈 且 症状=失眠/睡不好 → 孕期失眠护理",
  ...
  },
  {
    ...
    tags: [],
    display_tag: "",
    core_question: "宝妈产后失眠怎么缓解？",
    related_scenarios: ["激素波动", "夜奶", "焦虑", "产后抑郁"],
    decision_criteria: "对象=宝妈 且 症状=失眠/睡不好 → 产后失眠护理",
  ...
  // --- 宝妈产后情绪（哭闹/低落时选宝妈的分支）---
  {
    ...
    display_tag: "😢 宝妈产后情绪",
    core_question: "宝妈产后情绪低落/焦虑怎么处理？",
    related_scenarios: ["产后抑郁", "情绪波动", "激素变化", "心理支持"],
    decision_criteria: "对象=宝妈 且 症状=情绪低落/焦虑/哭 → 产后情绪护理",
    solution: "宝妈产后情绪波动很常见：\n1. 【接纳自己】激素变化、睡眠不足会让情绪起伏，不是你的错。\n2. 【争取休息】请家人帮忙带娃，哪怕每天多睡1小时也有帮助。\n3. 【找人聊聊】跟老公、闺蜜或妈妈说说，别憋着。\n4. 【就医指征】如果持续两周以上情绪低落、对什么都提不起兴趣、经常哭，建议咨询产科或心理科，排除产后抑郁。",
    warning: "如果出现伤害自己或宝宝的想法，请立即就医或拨打心理援助热线。",
    fallback_suggestions: ["产后抑郁有什么表现？", "家人怎么支持产后妈妈？"]
  }
];
